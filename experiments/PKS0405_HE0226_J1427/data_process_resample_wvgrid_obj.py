...
def get_train_and_val(mask, cube, wave_grid, train_split=0.8):
    ...
    sky_spec = apply_mask(data, mask, extract_value=1) # extract value: 0, sky; 1, object
    sky_var = apply_mask(var, mask, extract_value=1)
...
torch.save(input_tensor_train, data_path + 'PKS0405_HE0226_J1427_input_tensor_obj_train_v6.pt')
torch.save(input_tensor_val, data_path + 'PKS0405_HE0226_J1427_input_tensor_obj_val_v6.pt')
...
torch.save(input_tensor_train_clipped, data_path + 'PKS0405_HE0226_J1427_input_tensor_obj_train_clipped_v6.pt')
torch.save(input_tensor_val_clipped, data_path + 'PKS0405_HE0226_J1427_input_tensor_obj_val_clipped_v6.pt')
...
torch.save(input_tensor_train_var, data_path + 'PKS0405_HE0226_J1427_input_tensor_obj_train_var_v6.pt')
torch.save(input_tensor_val_var, data_path + 'PKS0405_HE0226_J1427_input_tensor_obj_val_var_v6.pt')
del input_tensor_train_var
del input_tensor_val_var
gc.collect()


np.savetxt(data_path + 'PKS0405_HE0226_J1427_train_obj_test_v6.txt', train_test)
np.savetxt(data_path + 'PKS0405_HE0226_J1427_val_obj_test_v6.txt', val_test)
np.savetxt(data_path + 'PKS0405_HE0226_J1427_train_obj_test_clipped_v6.txt', train_test_clipped)
np.savetxt(data_path + 'PKS0405_HE0226_J1427_val_obj_test_clipped_v6.txt', val_test_clipped)
np.savetxt(data_path + 'PKS0405_HE0226_J1427_train_obj_test_var_v6.txt', train_test_var)
np.savetxt(data_path + 'PKS0405_HE0226_J1427_val_obj_test_var_v6.txt', val_test_var)
