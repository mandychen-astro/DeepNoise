...
class AutoEncoder(nn.Module):   
    def __init__(self, enc_in_channels, enc_out_channels, enc_kernel_size, enc_stride, enc_padding, 
        ...
        self.encoder = EncoderBlock(enc_in_channels, enc_out_channels, enc_kernel_size, enc_stride, enc_padding)
        self.decoder = DecoderBlock(dec_in_channels, dec_out_channels, dec_kernel_size, dec_stride, dec_padding)
