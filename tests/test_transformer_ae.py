...
sky_spec = sky_spec[:,:128] # only use the first 10 spectra for testing
...
# Train the model
trained_model = train_model(autoencoder, train_loader, criterion, optimizer, num_epochs=25, device='cpu')

torch.save(autoencoder.state_dict(), '../models/model_transformer_ae_state_dict.pth')
